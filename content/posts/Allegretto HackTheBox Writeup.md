+++
date = '2026-02-08T10:20:11+01:00'
draft = false
title = 'Allegretto a HTB Writeup'
+++
This writeup documents my analysis and investigation of the [Allegretto](https://app.hackthebox.com/sherlocks/Allegretto) sherlock on Hackthebox. This sherlock focuses heavily on filesystem forensics, email artifacts, browser data, and document metadata. Let’s get into it…
...
“[Thunderbird](https://www.thunderbird.net/) is a free, open-source, and privacy-focused desktop email client, personal information manager, and news client developed.”
...
Return-Path: [marcus@darkmail.htb](mailto:marcus@darkmail.htb)
X-Original-To: shadow152535@darkmail.htb
Delivered-To: shadow152535@darkmail.htb
...
To: [shadow152535@darkmail.htb](mailto:shadow152535@darkmail.htb)
User-Agent: mail (GNU Mailutils 3.14)
Date: Sun, 22 Sep 2024 12:54:03 +0000
Message-Id: [20240922125403.124B31790@mail.darkmail.htb](mailto:20240922125403.124B31790@mail.darkmail.htb)
From: marcus@darkmail.htb
...
This confirms Shadow’s Darkmail address is *shadow152535@darkmail.htb*
...
```
Message-ID: [8188fc07-72dc-445f-9e41-3b599f8c7155@darkmail.htb](mailto:8188fc07-72dc-445f-9e41-3b599f8c7155@darkmail.htb)
Date: Sun, 22 Sep 2024 19:25:58 +0100
MIME-Version: 1.0
User-Agent: Mozilla Thunderbird
Content-Language: en-GB
To: mark.chan@darkmail.htb
From: Shadow [shadow152535@darkmail.htb](mailto:shadow152535@darkmail.htb)
...
![Alt text](/images/htb-allegretto-sc1.png)
...
![Alt text](/images/htb-allegretto-sc2.png)
...
Shadow’s NTUSER.DAT registry hive was loaded into Registry Explorer. Searching for `@hotmail` revealed the following email address [*shadow152535@hotmail.com*](mailto:shadow152535@hotmail.com)



![Alt text](/images/htb-allegretto-sc3.png)
...
![Alt text](/images/htb-allegretto-sc4.png)
...
![Alt text](/images/htb-allegretto-sc5.png)
...
![Alt text](/images/htb-allegretto-sc6.png)
...
Inspecting the creation dates through `ls -l`or other tools will only reflect the decode time instead of the original creation time.
...
![Alt text](/images/htb-allegretto-sc7.png)
...
![Alt text](/images/htb-allegretto-sc8.png)


While investigating the recycle bin, i stumbled across these `.kml`files. “KML (Keyhole Markup Language) files are XML-based files used to display geographic data, such as points, lines, polygons, and 3D models, on 2D maps and 3D Earth browsers like Google Earth”

By inspecting one of these files i found the answer *E:\Locations\Item_Dropoff tracking.kml*



![Alt text](/images/htb-allegretto-sc9.png)
...
![Alt text](/images/htb-allegretto-sc10.png)




![Alt text](/images/htb-allegretto-sc11.png)
...
![Alt text](/images/htb-allegretto-sc12.png)
